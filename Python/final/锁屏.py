...
class App:
    ...
    def start(self,pythonFile,face_id,pid):
        self.button1.destroy()
        os.system(f"python {pythonFile} {face_id} {pid}")
        App()
    ...
    def version_10(self):
        ...
        self.button1=tk.Button(self.root,bd=0,bg='#0078d7',fg='white',font=10,width=12,height=12,text="点击开始人脸识别",command=lambda:self.start("./用户选择.py",face_id,pid))
